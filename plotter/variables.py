...
#     Variable('hnl_m_12', np.linspace(0., 12., 12 + 1), 'm_{23} (GeV)', 'events', extra_selection='hnl_2d_disp>5.0'                   , extra_label='lxy_mt_5p0'    ),
    ...
    Variable('hnl_2d_disp_sig_alt', np.linspace( 0   ,1000   , 25 + 1) , 'L_{xy}/\sigma_{xy}', 'events', extra_label='hnl_2d_disp_sig_alt_extended'),
    ...
    Variable('n_vtx' , np.linspace( 0  , 70, 14 + 1), '#PV', 'events', extra_label='n_vtx_coarse'),
